...
trait HasBaseProfileFeatures
{
    ...
    /**
     * Determine if the organization is managing profile photos.
     */
    public static bool $managesProfilePhotos = false;

    /**
     * Determine if the organization has a profile photo disk.
     */
    public static string $profilePhotoDisk = 'public';

    /**
     * Determine if the organization has a profile photo storage path.
     */
    public static string $profilePhotoStoragePath = 'profile-photos';

    /**
     * Determine if the organization is supporting API features.
     */
    ...
    /**
     * Determine if Organization is managing profile photos.
     */
    ...
    /**
     * Determine if Organization is supporting API features.
     */
