...
trait HasConnectedAccounts
{
    ...
    public function currentConnectedAccount(): BelongsTo
    {
        ...
        return $this->belongsTo(FilamentOrganizations::connectedAccountModel(), 'current_connected_account_id');
    }
    ...
    {
        return $this->hasMany(FilamentOrganizations::connectedAccountModel(), 'user_id', $this->getAuthIdentifierName());
    }
}
