...
class LogoutOtherBrowserSessionsForm extends Component
{
    ...
    public function logoutOtherBrowserSessions(): void
    {
        ...
        if (! Hash::check($this->password, Auth::user()->password)) {
            throw ValidationException::withMessages([
                'password' => [__('filament-organizations::default.errors.invalid_password')],
            ]);
        }
    ...
    {
        return view('filament-organizations::profile.logout-other-browser-sessions-form');
    }

    public function browserSessionsTerminated(): void
    {
        Notification::make()
            ->title(__('filament-organizations::default.notifications.browser_sessions_terminated.title'))
            ->success()
            ->body(__('filament-organizations::default.notifications.browser_sessions_terminated.body'))
            ->send();
    }
}
