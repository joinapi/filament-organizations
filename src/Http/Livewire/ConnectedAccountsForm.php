...
class ConnectedAccountsForm extends Component
{
    ...
    {
        return FilamentOrganizations::enabledProviders();
    }
    ...
    {
        return view('filament-organizations::profile.connected-accounts-form');
    }
    ...
    {
        Notification::make()
            ->title(__('filament-organizations::default.notifications.connected_account_removed.title'))
            ->success()
            ->body(__('filament-organizations::default.notifications.connected_account_removed.body'))
            ->send();
    }
}
